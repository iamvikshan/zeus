...
- `/design-help` -- Verify usage when command selection is ambiguous or when workers need command-discovery guidance before implementation.
...
- `/design-arrange` -- Verify usage when the task involves layout composition, spacing rhythm, or hierarchy restructuring.
