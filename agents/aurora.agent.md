...
- `/design-help` -- Map user goals to the right design command set before choosing execution commands.
...
- `/design-arrange` -- Improve layout composition, spatial hierarchy, and visual flow so interfaces feel intentional and scannable.
