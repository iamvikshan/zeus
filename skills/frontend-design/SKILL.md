...
<!-- Based on pbakaus/impeccable (Apache 2.0). See NOTICE.md for attribution. -->

This skill guides creation of distinctive, production-grade frontend interfaces that avoid generic "AI slop" aesthetics. Implement real working code with exceptional attention to aesthetic details and creative choices.

## Context Gathering Protocol

This is the canonical context protocol for all adapted `design-*` skills.
...
**DON'T**: Use gray text on colored backgrounds -- it looks washed out and dead on color. Use a darker shade of the background color instead
