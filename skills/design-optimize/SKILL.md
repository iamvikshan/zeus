...
description: >-
  Improve interface performance across loading speed, rendering, animations,
  images, and bundle size. Makes experiences faster and smoother.
---

<!-- Adapted from pbakaus/impeccable (Apache 2.0) -- see NOTICE.md -->

Identify and fix performance issues to create faster, smoother user
experiences.
...
2. **Identify bottlenecks**:
   ...
   - What's causing it? (Large images? Expensive JavaScript? Layout
     thrashing?)
...
**IMPORTANT**: Measure on real devices with real network conditions. Desktop
Chrome with fast connection isn't representative.
...
- Optimize micro-optimizations while ignoring major issues (optimize the
...
Remember: Performance is a feature. Fast experiences feel more responsive,
more polished, more professional. Optimize systematically, measure ruthlessly,
and prioritize user-perceived performance.
